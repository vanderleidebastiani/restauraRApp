												  					...
												  					shiny::fluidRow(
												  						...
												  						shiny::column(width = 8,
												  									  ...
												  									  shinydashboardPlus::box(width = 12, headerBorder = FALSE, 
												  									  						...
												  									  						# 								 status = "primary"
												  									  						# ),
												  									  						shiny::conditionalPanel(condition = "(input.specifyGroupsSimInput == 'Yes')",
												  					...
												  					shiny::fluidRow(
												  						...
												  						shiny::column(width = 8,
												  									  ...
												  									  shinydashboardPlus::box(width = 12, headerBorder = FALSE, 
												  									  						...
												  									  						# 								 status = "primary"
												  									  						# ),
												  									  						shiny::conditionalPanel(condition = "(input.specifyGroupsSelInput == 'Yes')",
												  									  												shinyWidgets::pickerInput(inputId = "groupSelInput",
												  									  																		  label = i18n$t("Site groups"),
												  									  																		  choices = NULL,
												  									  																		  multiple = TRUE,
												  									  																		  options = list(`actions-box` = TRUE),
												  									  																		  # options = list("max-options" = 1),
